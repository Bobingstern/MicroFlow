...
### Update Notes:
Version `1.1.2` released. I was trying to get it to work with the Arduino library manager so I hadto release a small patch. I'm working on new test cases and examples so stay tuned for that!
